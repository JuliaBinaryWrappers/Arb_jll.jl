...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Arb_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d9960996-1013-53c9-9ba4-74a4155039c3"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Arb", artifacts_toml) for e in artifacts["Arb"]]
...
if best_platform === nothing
    @debug("Unable to load Arb; unsupported platform $(triplet(platform_key_abi()))")
else
